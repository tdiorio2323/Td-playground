...
border: 2px solid rgba(255, 255, 255, 0.2);`,
  ...
  },
  {
    ...
    category: 'Glassmorphism',
    tailwindClass: 'bg-gradient-to-br from-white/15 via-white/10 to-white/15 backdrop-blur-md border-2 border-white/30',
...
border: 2px solid rgba(255, 255, 255, 0.3);`,
  ...
  },
  {
    ...
    tailwindClass: 'bg-gradient-to-br from-[#d9b24a] via-[#b58b32] to-[#6a4d1f] border border-[#f2d68e]/40',
