    ...
    <div className="space-y-6">
            ...
            >
              <CardContent className="p-4 flex flex-col items-center gap-3">
                <div className="w-12 h-12 flex items-center justify-center text-gray-700">
                  {IconComponent ? <IconComponent className="h-8 w-8" /> : <div className="text-xs">N/A</div>}
                </div>
                <div className="text-center space-y-1 w-full">
                  <p className="text-xs font-medium text-gray-900 truncate" title={icon.name}>
                    {icon.name}
                  </p>
                  <p className="text-xs text-gray-500 line-clamp-2 min-h-[2rem]" title={icon.description}>
                    {icon.description}
                  </p>
                </div>
                <Button
      ...
      <Card className="bg-blue-50 border-blue-200 mt-8">
        ...
        <CardContent className="text-xs text-blue-800 space-y-2">
          <p>All icons are from <code className="bg-blue-100 px-1 py-0.5 rounded">lucide-react</code></p>
