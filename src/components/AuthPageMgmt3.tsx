...
export const AuthPageMgmt3 = () => {
  ...
  return (
    ...
    >
      <Card className="w-full max-w-md bg-gradient-to-br from-white/15 via-white/10 to-white/15 backdrop-blur-md border-2 border-white/30 shadow-[0_10px_40px_rgba(0,0,0,0.5),inset_0_2px_4px_rgba(255,255,255,0.3)] relative z-10 before:absolute before:inset-0 before:bg-gradient-to-tr before:from-white/20 before:via-transparent before:to-white/10 before:pointer-events-none before:rounded-lg">
