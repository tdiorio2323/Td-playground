...
export const AuthPageLCG = () => {
  ...
  return (
    <div
      className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden bg-[url('/lovable-uploads/td\ studios\ black\ marble.png')] bg-cover bg-center"
    >
        ...
        <CardContent className="pb-8 px-8 relative z-20">
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-2">
              <label
                className="font-bold text-sm bg-gradient-to-r from-yellow-600 via-yellow-400 to-yellow-600 bg-clip-text text-transparent font-sans"
              >
                Username
              </label>
              <Input
            ...
            <div className="text-center mt-6">
              <a
                ...
                className="text-white/80 underline text-xs tracking-[0.28em] hover:text-white transition-colors font-semibold font-bebas"
              >
                WWW.LEGACYCAPNY.COM
              </a>
            </div>
